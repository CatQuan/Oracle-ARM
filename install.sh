...
cat <<EOF | \
  sudo tee /home/ubuntu/.config/autostart/pulseaudio.desktop
[Desktop Entry]
Type=Application
Exec=pulseaudio
Hidden=false
...
# Xrdp环境配置
function xrdp_conf() {
touch /home/ubuntu/.Xclients
echo "lxsession" > /home/ubuntu/.Xclients
chmod a+x /home/ubuntu/.Xclients
...
echo "Default Password: @616287whW"